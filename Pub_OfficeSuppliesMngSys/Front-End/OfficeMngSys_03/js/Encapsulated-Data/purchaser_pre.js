...
function loadDate(pn){
    ...
    $.ajax({
        type:"post",
        dataType:"json",
        url:"http://192.168.35.111:8080/officeSystem/ItemProcurement/PreItemProcurementHome.do",
...
//确定采购
  function Pre(element){
        ...
        $.ajax({
            type:"post",
            url:"http://192.168.35.111:8080/officeSystem/ItemProcurement/purchase.do",
            data:JSON.stringify(x),
            dataType:"json",
            header:{
