...
function load_wait_assess(){
    ...
    //    //url : 'http://139.129.28.117:8080/cammatmana/executeHQL.mvc?hql=from tb_material',//???
    //    type : "get",
    //    async : false,
    //    dataType : "jsonp",
    //    jsonp : "callBackParamName", //????????????callback?????function???????
    //    jsonpCallback : "callBackName", //callback??function????,????????????data???????
    //    success : function() {
    //        alert("1323");
    //    },
    //    error : function() {
    ...
    $.ajax({
        ...
        //url : 'http://127.0.0.1:8080/cammatmana/back/executeHql.mvc?hql=from Material',//???
        type: "get",
        async: false,
        dataType: "jsonp",
        jsonp: "callBackParamName", //????????????callback?????function???????
    ...
    //$.ajax({
    //    url : 'http://192.168.199.104:8080/cammatmana/login.mvc?account=1012013001&password=123456',//???
    //    //url : 'http://192.168.199.104:8080/cammatmana/executeHQL.mvc?hql=from tb_material',//???
    //    type : "get",
    //    async : false,
    //    dataType : "jsonp",
    //    jsonp : "callBackParamName", //????????????callback?????function???????
   ...
   //         //    html1 +='<button type="button" class="btn">??????</button>';
   //         //    html1 +='</div>';
   //         //    html1 +='</div>';
   //         //}
   //         //$("#like").append(html1);
