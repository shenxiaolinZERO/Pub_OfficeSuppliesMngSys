...
function loadDate(pn){
    ...
    $.ajax({
        type:"post",
        dataType:"json",
        url:"http://localhost:8080/officeSystem/BorrowApply/userCurrentBorrowApply.do",
        ...
        success:function(data){
            ...
            if(1){
                ...
                for(var i=0;i<data.resultList.length;i++){
                    ...
                    html1 +='<td><button id="'+array.id+'" onclick="apply(this)">申请</button></td>';
                    html1 +='</tr>';
                }
                $("tbody").append(html1);
...
//确定预采购
  function apply(element){
        ...
        $.ajax({
            type:"post",
            url:"http://localhost:8080/officeSystem/ BorrowApply/submitBorrowApply.do",
            data:JSON.stringify(x),
            dataType:"json",
            header:{
