...
public class InStorageCheckIn {
	...
	private String itemProcurementId;//物品清单--采购清单（可以批量入库）用'-'拼接
	...
	public String getItemProcurementId() {
		return itemProcurementId;
	}

	public void setItemProcurementId(String itemProcurementId) {
		this.itemProcurementId = itemProcurementId;
	}
	...
	public String toString() {
		return "InStorageCheckIn [id=" + id + ", inStorageDate=" + inStorageDate + ", inStorageTypeId="
				...
				+ ", itemProcurementId=" + itemProcurementId + ", totalNumber=" + totalNumber + ", totalMonney="
	...
	public InStorageCheckIn(String id, Date inStorageDate, short inStorageTypeId, String supplierId, String agentId,
			String operaterId, String itemProcurementId, Long totalNumber, Double totalMonney, String remark) {
		super();
		this.id = id;
		this.inStorageDate = inStorageDate;
		this.inStorageTypeId = inStorageTypeId;
