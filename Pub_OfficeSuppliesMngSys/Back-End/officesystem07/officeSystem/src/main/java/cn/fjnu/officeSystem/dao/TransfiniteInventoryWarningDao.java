...
public interface TransfiniteInventoryWarningDao {//库存预警
	 ...
	 * @return
	 */
	public int updateAddTransfiniteInventoryByItemId(@Param("itemId") String itemId,@Param("addNum")Long addNum);
	
	/**
	 * 通过商品id更新库存预警表
	 */
	public int updateSubTransfiniteInventoryByItemId(@Param("itemId") String itemId,@Param("addNum")Long addNum);
   /**
    * 
    * @param itemTypeId
    * @param state 
    ...
    */
	...
	public TransfiniteInventoryWarning selectTransfiniteInventoryWarningByItemId(String itemId);
